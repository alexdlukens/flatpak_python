...
class QualityModerationDashboardResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["apps", "pagination"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [QualityModerationDashboardRow.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
