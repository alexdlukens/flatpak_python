...
class BodyGetDownloadTokenPurchasesGenerateDownloadTokenPost(BaseModel):
    """
    BodyGetDownloadTokenPurchasesGenerateDownloadTokenPost
    """ # noqa: E501
    appids: List[StrictStr]
    update_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["appids", "update_token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "update_token": obj.get("update_token")
        })
        return _obj
