...
class TokensResponse(BaseModel):
    ...
    is_direct_upload_app: StrictBool
    __properties: ClassVar[List[str]] = ["tokens", "is_direct_upload_app"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tokens": [TokenResponse.from_dict(_item) for _item in obj["tokens"]] if obj.get("tokens") is not None else None,
            "is_direct_upload_app": obj.get("is_direct_upload_app")
        })
        return _obj
