...
KEYSVALUE_ANY_OF_SCHEMAS = ["List[object]", "bool", "object", "str"]

class KeysValue(BaseModel):
    """
    KeysValue
    """
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[object], bool, object, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[object]", "bool", "object", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = KeysValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in KeysValue with anyOf schemas: List[object], bool, object, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into KeysValue with anyOf schemas: List[object], bool, object, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[object], bool, object, str]]:
