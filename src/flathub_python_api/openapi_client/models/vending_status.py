...
class VendingStatus(BaseModel):
    ...
    """ # noqa: E501
    status: StrictStr
    can_take_payments: StrictBool
    needs_attention: StrictBool
    details_submitted: StrictBool
    __properties: ClassVar[List[str]] = ["status", "can_take_payments", "needs_attention", "details_submitted"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "can_take_payments": obj.get("can_take_payments"),
