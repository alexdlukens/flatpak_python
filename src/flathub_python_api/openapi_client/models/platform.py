...
class Platform(BaseModel):
    ...
    keep: StrictInt
    stripe_account: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["depends", "aliases", "keep", "stripe_account"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if depends (nullable) is None
        # and model_fields_set contains the field
        if self.depends is None and "depends" in self.model_fields_set:
            _dict['depends'] = None

        # set to None if stripe_account (nullable) is None
        # and model_fields_set contains the field
        if self.stripe_account is None and "stripe_account" in self.model_fields_set:
            _dict['stripe_account'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keep": obj.get("keep"),
            "stripe_account": obj.get("stripe_account")
        })
        return _obj
