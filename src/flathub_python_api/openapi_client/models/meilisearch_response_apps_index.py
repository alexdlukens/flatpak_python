...
class MeilisearchResponseAppsIndex(BaseModel):
    """
    ...
    hits_per_page: StrictInt = Field(alias="hitsPerPage")
    page: StrictInt
    total_pages: StrictInt = Field(alias="totalPages")
    total_hits: StrictInt = Field(alias="totalHits")
    __properties: ClassVar[List[str]] = ["hits", "query", "processingTimeMs", "hitsPerPage", "page", "totalPages", "totalHits"]
