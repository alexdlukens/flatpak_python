...
class TestWebsiteVerificationResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebsiteVerificationResult:
        """Test WebsiteVerificationResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebsiteVerificationResult`
        """
        model = WebsiteVerificationResult()
        if include_optional:
    ...
    def testWebsiteVerificationResult(self):
        """Test WebsiteVerificationResult"""
