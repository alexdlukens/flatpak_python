...
class TokenModel(BaseModel):
    ...
    created: datetime
    changed: datetime
    __properties: ClassVar[List[str]] = ["id", "state", "name", "token", "created", "changed"]

    @field_validator('state')
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unredeemed', 'redeemed', 'cancelled']):
            raise ValueError("must be one of enum values ('unredeemed', 'redeemed', 'cancelled')")
        return value
