...
class ModerationApp(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["requests", "requests_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [ModerationRequestResponse.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None,
