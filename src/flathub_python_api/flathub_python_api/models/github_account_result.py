...
class GithubAccountResult(BaseModel):
    ...
    id: StrictInt
    github_userid: StrictInt
    login: StrictStr
    avatar_url: Optional[StrictStr]
    display_name: Optional[StrictStr]
    email: Optional[StrictStr]
    last_used: Optional[datetime]
    __properties: ClassVar[List[str]] = ["provider", "id", "github_userid", "login", "avatar_url", "display_name", "email", "last_used"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "github_userid": obj.get("github_userid"),
            "login": obj.get("login"),
