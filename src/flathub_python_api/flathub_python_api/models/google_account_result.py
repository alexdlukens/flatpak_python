...
class GoogleAccountResult(BaseModel):
    ...
    id: StrictInt
    google_userid: StrictInt
    login: StrictStr
    avatar_url: Optional[StrictStr]
    display_name: Optional[StrictStr]
    email: Optional[StrictStr]
    last_used: Optional[datetime]
    __properties: ClassVar[List[str]] = ["provider", "id", "google_userid", "login", "avatar_url", "display_name", "email", "last_used"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "google_userid": obj.get("google_userid"),
            "login": obj.get("login"),
