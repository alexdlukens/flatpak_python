...
class ModerationAppsResponse(BaseModel):
    ...
    apps_count: StrictInt
    __properties: ClassVar[List[str]] = ["apps", "apps_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [ModerationAppItem.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
            "apps_count": obj.get("apps_count")
        })
        return _obj
